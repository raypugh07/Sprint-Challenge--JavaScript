...
const tyrannosaurus={
  ...
  speech:'RAWERSRARARWERSARARARRRR!'
...
console.log(tyrannosaurus.speech);
...
// Given this zoo data from around the United States, follow the instructions below.  Use the specific array methods in the requests 
...
zooAnimals.map(function (zooAnimals,index){

  lowerCase[index]=zooAnimals.animal_name.toLowerCase();
...
let largerPopulation = [];
 ...
 largerPopulation=zooAnimals.filter(function(zooAnimals){
...
populationTotal = zooAnimals.reduce(function (totalValue, zooAnimals) {

  return totalValue + zooAnimals.population;
}, 0);
